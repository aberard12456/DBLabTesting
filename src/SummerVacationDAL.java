...
public class SummerVacationDAL
{
    ...
    public List<String> TryGetDestinationForActivity(String activityName)
    {
      ...
      public boolean addPlan(String activityName, String parkName) throws SQLException{
        CallableStatement myStoredProcedureCall = connection.prepareCall("{Call addPlan(?, ?)}");
        myStoredProcedureCall.setString(1, activityName);
        myStoredProcedureCall.setString(2, parkName);
